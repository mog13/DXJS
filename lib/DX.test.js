...
describe("When using the DX library",() =>{
    ...
    describe("and im using a custom dice", ()=>{
        beforeEach(()=>{
            DX.addDice("elements",["fire","wind","earth","water"]);
        });

        it("should let me roll a handful of custom dice",()=>{
           let output = DX.roll("2elements");
